...
PATH_TO_CKPT = '/opt/object_detection_api_app/trained_model/frozen_inference_graph.pb'
PATH_TO_LABELS = '/opt/object_detection_api_app/trained_model/label_map.pbtxt'
